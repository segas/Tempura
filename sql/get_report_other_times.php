...
$result = mysqli_query($con, "SELECT type, datefrom, dateto, halfaday FROM nonbuisnesstime WHERE fs_user = '".$id_user."' AND MONTH(datefrom) = '".$month."' AND YEAR(datefrom) = '".$year."'");
$counter = 0;
