...
$result = mysqli_query($con, "SELECT id_worktime, date, timeamfrom, timeamto, timepmfrom, timepmto, pause, restday, worktime, fs_user FROM worktime_view WHERE fs_user = '".$id_user."' AND date >= '".$datestart."' AND date <= '".$dateend."'");
$counter = 0;
